...
const UIStrings = {
  ...
  /** Descriptive title of a Lighthouse audit that provides detail on the web page's document meta description. This imperative title is shown when the document does not have a meta description. */
